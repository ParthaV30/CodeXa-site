...
const notificationMessages = {
  cooldown: 'Error sending email.<br>The email limit of <span class="highlight">3</span> has been reached.<br>Please try again 24 hours after sending the last email.',
  error: 'An error occurred while sending the email.<br>Please try again later.',
  success: 'Email successfully sent.<br>Number of emails that can be sent<br>in the next 24 hours: <span class="highlight"></span>.'
}
